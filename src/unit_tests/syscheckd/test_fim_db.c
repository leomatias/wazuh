...
static void wraps_fim_db_decode_full_row() {
    ...
    expect_value(__wrap_sqlite3_column_int, i, 2);
    will_return(__wrap_sqlite3_column_int, 1); // mode
    expect_value(__wrap_sqlite3_column_int, i, 3);
    ...
    expect_value(__wrap_sqlite3_column_int, i, 6);
    ...
    expect_value(__wrap_sqlite3_column_int, i, 8);
...
void test_fim_db_get_path_range_failed(void **state) {
    ...
    expect_string(__wrap__merror, formatted_msg, "Failed to create temporal storage '/var/ossec/tmp/tmp_19283746523452345'");
#else
    expect_string(__wrap_fopen, path, "tmp/tmp_19283746523452345");
    expect_string(__wrap__merror, formatted_msg, "Failed to create temporal storage 'tmp/tmp_19283746523452345'");
#endif
...
void test_fim_db_get_count_range_error_stepping(void **state) {
    ...
    expect_any_count(__wrap_sqlite3_bind_text, a, 2);
    expect_any_count(__wrap_sqlite3_bind_text, b, 2);
